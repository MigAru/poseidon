...
func (c Controller) CreateUpload(ctx http.Context) error {
	...
	//уникальный id загрузки(чтобы докер отслеживал)
...
func (c Controller) Upload(ctx http.Context) error {
	...
	if err != nil {
		ctx.JSON(http2.StatusBadRequest, errors.ErrorResponse{Errors: []error{
			errors.DockerError{
				Code:    "",
...
func (c Controller) Get(ctx http.Context) error {
	...
	if err != nil {
		...
		ctx.JSON(404, errors.CreateErrorResponse(
			errors.DockerError{
				Code:    "BLOB_UPLOAD_UNKNOWN",
				Message: "blob unknown to registry",
				Detail: `This error may be returned when a blob is unknown to the registry in a specified repository. 
